...
from revoke_utils import revoke_cert as revoke_certificate, check_revocation_status
...
class CADemoApp(tk.Tk):
    ...
    def revoke_cert(self):
        ...
        if not all(os.path.exists(p) for p in [cert_file, issuer_cert, issuer_key]):
            messagebox.showerror("Lỗi", "Thiếu file chứng chỉ/khóa để thu hồi!")
            return
